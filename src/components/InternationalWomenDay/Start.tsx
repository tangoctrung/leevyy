  ...
  return (
    <div>
      <div className='relative w-[96%] sm:w-[600px] aspect-[8/5] rounded-xl'>
        <div className='absolute z-[-1] top-0 left-0 w-full h-full bg-[#0077b6] rounded-xl blur-xl'></div>
        <div className='w-full h-full bg-[#2888bc] rounded-xl p-5 overflow-scroll scrollbar-none'>
